                ...
                <td>{{$ManageLandlord ->firstname}}</td>
                  ...
                  <td class="text-right py-0 align-middle">
                    <div class="btn-group btn-group-sm">
                      <a href="#" class="btn btn-info"><i class="fas fa-eye">Update</i></a>
                      <a href="{{action('ManageLandlordController@destroy', [$ManageLandlord->id])}}" class="btn btn-danger"><i class="fas fa-trash">Delete</i></a>
                    </div>
                  </td>
                <tr>
