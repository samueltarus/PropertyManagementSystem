              ...
              <div  class="alert alert-danger">
                  ...
                  <form method="POST" action="{{action('TenantController@update',$id)}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ $tenant->username }} " required autocomplete="username" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="passport" type="text" class="form-control @error('passport') is-invalid @enderror" name="passport" value="{{ $tenant->passport }}" required autocomplete="passport" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $tenant->email  }}" required autocomplete="email" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ $tenant->address }}" required autocomplete="address" autofocus>
                          ...
                          <div class="form-group row">
                            <label for="phone_number" class="col-md-4 col-form-label text-md-right">{{ __('Contact PhoneNumber') }}</label>
    
                            <div class="col-md-6">
                                <input id="phone_number" type="text" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ $tenant->phone_number }}" required autocomplete="phone_number" autofocus>
